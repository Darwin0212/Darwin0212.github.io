...
function clik (btn){
  btn.textContent == "Iya 🤗" ? img.src = "img/bunga.gif" : img.src = "img/cat.gif" 
  button[0].style.display = "none"
  button[1].style.display = "none"
  ctn.style.height = "250px"
  ctn.style.width = "270px"
  return btn.textContent == "Iya 🤗" ? kata.textContent = "😍 ni buat Talitaku 🍊" : kata.textContent = "sini aku cium kamu biar semangat"
...
function content(){
  ...
  kata.textContent = "Hay sayang ku, cuma mau bilang, semangat ya puasanya hehehe😊"
}
